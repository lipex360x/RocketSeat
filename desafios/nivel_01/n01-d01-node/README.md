...
<h2 align="center">Conceitos do Node.js</h2>

<p align="center">
	<img alt="GitHub language count"  src="https://img.shields.io/github/languages/count/lipex360x/n01-d01-node?color=%2304D361">
...
## :rocket: Desafio
Interagir com rotas e métodos de armazenamento de objetos em um Array local, armazenando, listando, atualizando e removendo tais objetos.

## :dart: Solução
Este foi o primeiro desafio do [Gostack Rocketseat](https://github.com/Rocketseat/bootcamp-gostack-desafios/blob/master/desafio-conceitos-reactjs/README.md), onde eu deveria criar uma aplicação para treinar o que aprendi sobre os conceitos do Node.js!
